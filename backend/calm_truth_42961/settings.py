"""
Django settings for calm_truth_42961 project.
...
ROOT_URLCONF = 'calm_truth_42961.urls'
...
WSGI_APPLICATION = 'calm_truth_42961.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_truth_42961 API",
    "DESCRIPTION": "API documentation for calm_truth_42961 App",
    "VERSION": "v1",
}
